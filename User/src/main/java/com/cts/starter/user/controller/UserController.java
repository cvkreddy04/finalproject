package com.cts.starter.user.controller;
...
import com.cts.starter.user.dao.UserRepository;
import com.cts.starter.user.email.EmailService;
...
public class UserController {
	...
	return userRepository.findAll();
	 ...
	 mailContain.append("<a href='http://localhost:8070/User/UserPortal/confirmEmail/"+user.getEmail()+">Click</a>\n");
